        ...
        <div v-if="!edited" class="grid grid-cols-12">
            <div class="col-span-6">
                <div class="mb-3">
                    ...
                    <span class="p-1 px-3 rounded-lg bg-emerald-600 text-white text-sm uppercase">On Process</span>
                </div>
                <div class="mb-3">
                    <span class="block text-slate-500 text-xs mb-2 whitespace-nowrap">Stage</span>
                    <span class="font-medium text-sm whitespace-nowrap">Interview User</span>
                </div>
                <div class="mb-3">
        ...
        <div v-if="showForm" class="fixed bg-black/20 top-0 end-0 start-0 bottom-0 flex items-center justify-center">
            <div class="p-4 rounded-lg bg-white w-[50em] max-h-[88vh] overflow-auto">
                <div class="flex items-center justify-between mb-3">
                    <div class="font-medium">Form Interview User</div>
