<template>
    <div>
        <div class="flex items-center gap-3 mb-4">
            ...
            <button @click="action.delete = true" class="p-2 px-4 bg-rose-600 text-white text-sm rounded-lg flex items-center gap-2"><span v-if="selectedId.length > 0" class="p-1 flex items-center justify-center w-[20px] h-[20px] rounded-lg bg-rose-100 text-rose-700">{{ selectedId.length }}</span> Reject</button>
        </div>
        ...
        <BlockActionCandidateDuplicate :selectedId="selectedId" v-if="action.duplicate" @close="action.duplicate = false" />
