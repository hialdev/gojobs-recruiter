            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg overflow-hidden">
                ...
                <tbody>
                    <tr v-for="(job, index) in jobs" :key="job.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td v-else-if="role == 4 || role == 0" class="px-3 py-3 text-sm">
                            <div class="relative">
                                <!-- 3 Dots -->
                        ...
                        <td v-else class="px-3 py-3 text-sm"><div class="flex items-center justify-center w-[20px] h-[20px] bg-emerald-100 text-emerald-600 rounded-3xl p-1"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 16 16"><path fill="currentColor" fill-rule="evenodd" d="M13.488 3.43a.75.75 0 0 1 .081 1.058l-6 7a.75.75 0 0 1-1.1.042l-3.5-3.5A.75.75 0 0 1 4.03 6.97l2.928 2.927l5.473-6.385a.75.75 0 0 1 1.057-.081Z" clip-rule="evenodd"/></svg></div></td>
                    </tr>
                </tbody>
            </table>
