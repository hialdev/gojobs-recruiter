            ...
            <div class="grid grid-cols-12 gap-0 md:gap-4">
                <div class="col-span-12">
                    <div class="flex flex-wrap items-center justify-end gap-4 my-5 px-5">
                        ...
                        <PartialFormButton :customClass="`text-sm bg-emerald-100 text-emerald-700`" :primary="false">Simpan</PartialFormButton>
                        <PartialFormButton class="flex gap-5 items-center justify-between px-5 rounded-lg text-sm">Download CV
                ...
                <div class="col-span-12 lg:col-span-4">
                    <div class="bg-white rounded-0 md:rounded-2xl p-6">
                        <div class="flex flex-col items-center md:gap-1 border-b pb-5 relative">
                            <PartialFormImageupload />
                            <span class="text-xs text-slate-500">Klik gambar untuk upload</span>
                            <PartialFormInput class="w-full max-w-[20em]" :inputClass="`text-center rounded-[99px] focus:rounded-3xl focus:border-transparent w-full block`" :placeholder="`Nama Lengkap`" />
                            ...
                            <div class="flex flex-col items-center gap-3 my-3">
                                <div class="flex items-center gap-4">
                                    ...
                                    <PartialFormInput :placeholder="`username`" />
                                </div>
                                <div class="flex items-center gap-4">
                        ...
                        <ul class="flex flex-col py-5 border-b">
                            ...
                            <li class="flex items-center gap-4 text-sm">
                                ...
                                <div class="w-full">
                                    <PartialFormInput :placeholder="`Tempat Lahir`" />
                                    <PartialFormInput :type="`date`" :placeholder="username" />
                                </div>
                            </li>
                            <li class="flex items-center gap-4 text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                            ...
                            <li class="flex items-center gap-4 text-sm">
                                ...
                                <PartialFormInput :type="`number`" class="w-full" :customClass="`mb-0`" :placeholder="`expetasi gaji (Rupiah)`" />
                            </li>
                            <li class="flex items-center gap-4 text-sm">
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex items-center gap-2">
                                        <PartialFormInput :type="`number`" :placeholder="`BB`" />
                                        kg
                                    </div>
                                    /
                                    <div class="flex items-center gap-2">
                                        <PartialFormInput :type="`number`" :placeholder="`TB`" />
                                        cm
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="flex flex-col py-5">
                            ...
                            <li class="flex items-center gap-4 text-sm">
                                ...
                                <PartialFormInput class="w-full" :type="`number`" :placeholder="`No telp/Whatsapp`" />
                            </li>
                            <li class="flex items-center gap-4 text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                ...
                                <PartialFormInput class="w-full" :type="`email`" :placeholder="`Email`" />
                            </li>
                            <li class="flex items-center gap-4 text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                                ...
                                <PartialFormInput class="w-full" :placeholder="`Provinsi`" />
                            </li>
                            <li class="flex items-start gap-4 text-sm">
                                ...
                                <textarea class="w-full rounded-lg border border-slate-200 text-sm p-2 px-4" rows="5" :placeholder="`Alamat lengkap domisili`" ></textarea>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="pt-5">
                            <div v-if="show.pengalaman" class="grid grid-cols-12 gap-x-5 py-3 mb-5">
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Jabatan / Posisi`" :label="`Jabatan / Posisi`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Nama Perusahaan`" :label="`Nama Perusahaan`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Lokasi kerja`" :label="`Lokasi kerja`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :label="`Tgl Mulai Kerja`" :type="`date`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :label="`Tgl Berakhir`" :type="`date`" />
                                ...
                                <div class="col-span-12">
                                    <div class="flex items-center justify-end gap-3 mt-4">
                                        <PartialFormButton @click="show.pengalaman = false" :primary="false">Batal</PartialFormButton>
                                        <PartialFormButton>Tambahkan</PartialFormButton>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-0 md:rounded-2xl p-6 mb-5">
                        ...
                        <div class="pt-5">
                            <div v-if="show.pendidikan" class="grid grid-cols-12 gap-x-5 py-3 mb-5">
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Nama Kampus / Univ / Institute`" :label="`Nama Kampus / Univ / Institute`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Kejuruan / Program Studi`" :label="`Kejuruan / Program Studi`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Lokasi`" :label="`Lokasi`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`IPK`" :label="`IPK`" :type="`number`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :label="`Tgl Mulai`" :type="`date`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :label="`Tgl Berakhir`" :type="`date`" />
                                ...
                                <div class="col-span-12">
                                    <div class="flex items-center justify-end gap-3 mt-4">
                                        <PartialFormButton @click="show.pendidikan = false" :primary="false">Batal</PartialFormButton>
                                        <PartialFormButton>Tambahkan</PartialFormButton>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-0 md:rounded-2xl p-6 mb-5">
                        ...
                        <div class="pt-5">
                            <div v-if="show.organisasi" class="grid grid-cols-12 gap-x-5 py-3 mb-5">
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Nama Lembaga / Organisasi`" :label="`Nama Lembaga / Organisasi`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :placeholder="`Peran / Posisi`" :label="`Peran / Posisi`" />
                                </div>
                                <div class="col-span-12 md:col-span-6">
                                    <PartialFormInput :label="`Tgl Mulai`" :type="`date`" />
                                </div>
                                ...
                                <div class="col-span-12">
                                    <div class="flex items-center justify-end gap-3 mt-4">
                                        <PartialFormButton @click="show.organisasi = false" :primary="false">Batal</PartialFormButton>
                                        <PartialFormButton>Tambahkan</PartialFormButton>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-0 md:rounded-2xl p-6 mb-5">
                        ...
                        <div class="pt-5">
                            <div v-if="show.skill" class="grid grid-cols-12 gap-x-5 py-3 mb-5">
                                <div class="col-span-12">
                                    <PartialFormInput :placeholder="`Keterampilan`" :label="`Keterampilan`" />
                                </div>
                                <div class="col-span-12">
                                ...
                                <div class="col-span-12">
                                    <div class="flex items-center justify-end gap-3 mt-4">
                                        <PartialFormButton @click="show.skill = false" :primary="false">Batal</PartialFormButton>
                                        <PartialFormButton>Tambahkan</PartialFormButton>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-0 md:rounded-2xl p-6 mb-5">
                        ...
                        <div class="pt-5">
                            <div v-if="show.bahasa" class="grid grid-cols-12 gap-x-5 py-3 mb-5">
                                <div class="col-span-12">
                                    <PartialFormInput :placeholder="`Bahasa`" :label="`Bahasa`" />
                                </div>
                                <div class="col-span-12 lg:col-span-4">
                                ...
                                <div class="col-span-12">
                                    <div class="flex items-center justify-end gap-3 mt-4">
                                        <PartialFormButton @click="show.bahasa = false" :primary="false">Batal</PartialFormButton>
                                        <PartialFormButton>Tambahkan</PartialFormButton>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-span-6">
                                    <div class="relative">
                                        <div class="absolute top-0 end-0 flex items-center justify-center w-[20px] h-[20px]">
                                           <svg class="text-emerald-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <path d="M15 5.9997L18 8.9997M13 19.9997H21M5 15.9997L4 19.9997L8 18.9997L19.586 7.4137C19.9609 7.03864 20.1716 6.53003 20.1716 5.9997C20.1716 5.46937 19.9609 4.96075 19.586 4.5857L19.414 4.4137C19.0389 4.03876 18.5303 3.82812 18 3.82812C17.4697 3.82813 16.9611 4.03876 16.586 4.4137L5 15.9997Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>     
                                        </div>
