        ...
        <div class="bg-black/60 flex items-center justify-center p-12 min-h-screen fixed top-0 w-full z-[99] max-h-screen">
            <div class="bg-white p-6 py-9 rounded-3xl w-full max-w-[30em] relative overflow-hidden">
                ...
                <div class="flex items-center gap-2 border-2 hover:border-2 p-3 px-4 rounded-xl hover:border-primary mb-3">
                    <input type="password" class="w-full block focus:outline-0" placeholder="password">
                    <div class="w-[20px]">
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <NuxtLink to="" class="text-blue-600 underline text-sm">Lupa Sandi</NuxtLink>
                </div>
                <div class="flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-300 rounded-2xl bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800" role="alert">
                ...
                <PartialsButton class="w-full text-center">Login</PartialsButton>
