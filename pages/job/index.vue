<template>
    <div class="container mx-auto p-5">
        <div class="flex flex-wrap items-center gap-5 mb-5">
            ...
            <div @click="resetFilters" class="cursor-pointer text-sm hover:text-emerald-600 whitespace-nowrap">Hapus Semua</div>
            ...
            <button v-if="role == 4" @click="addJob" class="px-4 pe-5 whitespace-nowrap py-2 bg-emerald-600 text-white rounded-lg flex items-center gap-3">
