<template>
    <div class="bg-slate-100">
        <div class="container mx-auto py-[2em] px-5">
            <div class="mb-7">
                <Filtering />
            </div>
    ...
    data(){
        return{
            jobs : [
                {
                    id: 1,
                    companyLogo: "/image/company/1.png",
                    companyName: "Google",
                ...
                {
                    id: 2,
                    companyLogo: "/image/company/2.png",
                ...
                {
                    id: 3,
                    companyLogo: "/image/company/3.png",
                    companyName: "Amazon",
                    title: "Product Manager",
                    location: "Seattle, WA",
                    salary: "USD 130,000 - 160,000 per year",
                    jobType: "Full-time",
                    uploadDate: "4 hari yang lalu",
                },
                {
                    id: 4,
                    companyLogo: "/image/company/4.png",
                ...
                {
                    id: 5,
                    companyLogo: "/image/company/5.png",
                    companyName: "Apple",
                    title: "iOS Developer",
                    location: "Cupertino, CA",
                    salary: "USD 120,000 - 150,000 per year",
                    jobType: "Full-time",
                    uploadDate: "6 hari yang lalu"
                },
                {
                    id: 6,
                    companyLogo: "/image/company/6.png",
                    companyName: "Netflix",
