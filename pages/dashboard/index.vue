            ...
            <div class="col-span-8">
                ...
                <div class="p-5 bg-white rounded-xl mb-3">
                    <div class="flex items-center gap-6 border-b pb-3 mb-3">
                        ...
                        <NuxtLink to="/job" class="ms-auto text-emerald-600 underline">View All Job</NuxtLink>
                    </div>
            ...
            <div class="col-span-4">
                ...
                <table class="w-full rounded-xl overflow-hidden">
                    ...
                    <tr class="border-b bg-white">
                        <th class="text-start p-3 px-5 text-sm font-medium">Psikotest</th>
                        <td><span class="p-1 px-2 rounded-lg bg-emerald-600 text-white text-sm">197</span></td>
                    </tr>
                    <tr class="border-b bg-white">
                        <td class="text-start p-3 px-5 text-sm text-slate-500">On Process</td>
                        <td><span class="text-sm text-slate-600">197</span></td>
                    </tr>
                    <tr class="border-b bg-white">
                        <td class="text-start p-3 px-5 text-sm text-slate-500">Psikotest</td>
                        <td><span class="text-sm text-slate-600">197</span></td>
                    </tr>
                    <tr class="border-b bg-white">
                        <td class="text-start p-3 px-5 text-sm text-slate-500">Psikotest</td>
